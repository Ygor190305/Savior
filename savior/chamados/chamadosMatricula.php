...
<body>
    ...
    <section class="container">
            ...
            <form class="row g-3" action="chamadosMatricula.php" method="GET">
                <div class="col-auto">
    ...
    <?php
        ...
        //{idpessoa} retorna id do usuario logado
        ...
        //retorna dados do chamado para exibir na tabela
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-8 bg-white text-left p-2 offset-2">
                        <form action="cadastroChamadoUsuario.php" method="post">
